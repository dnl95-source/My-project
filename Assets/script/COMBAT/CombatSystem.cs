...
namespace Game.Combat
{
    public static class CombatSystem
    {
        ...
        private static CombatStats GetCombatStatsFromObject(GameObject obj)
        {
            ...
            if (status != null && status.combatStats != null) return status.combatStats;
            ...
            foreach (var c in comps)
            {
                ...
                foreach (var prop in t.GetProperties(BindingFlags.Public | BindingFlags.Instance))
                {
                    ...
                    // If the property already yields a namespaced CombatStats, return it
                    if (raw is CombatStats nsVal) return nsVal;

                    // If the property yields the global CombatStats, convert and return
