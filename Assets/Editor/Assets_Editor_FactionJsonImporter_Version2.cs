...
public class FactionJsonImporter : EditorWindow
{
    ...
    static void ImportJson(string path)
    {
        ...
        // Usa un wrapper dinamico per mappare JSON ai campi o creare un asset semplice
        // Qui useremo JsonUtility su un tipo intermedio
