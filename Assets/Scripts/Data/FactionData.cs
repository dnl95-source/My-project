...
public class FactionData : ScriptableObject
{
    ...
    public BiomeType[] primaryBiomes; // enum BiomeType { Plains, Forest, Mountain, Coast, Swamp, Desert, Sea }
...
public enum BiomeType { Plains, Forest, Mountain, Coast, Swamp, Desert, Sea }